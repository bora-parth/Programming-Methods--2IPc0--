...
//# BEGIN TODO: Provide method implementation
        ...
        // if  k > c and c != 0 then for no positive value of /result will c == \result + k hold
        if (k > c && c != 0) {
            result = -1L;
        }
        ...
        // if c > 0 then for no value of /result will c == \result * 0 hold
        else if (k == 0L) {
            result = -1L;
        }
        
        // if c is divisible by k then c == \result * k
        else if (c%k == 0) {
            result = c/k;
        } 
